...
CREATE TABLE posts (
  ...
  image_id     INTEGER, --FK reference to image table 
...
CREATE TABLE likes (
  id         SERIAL PRIMARY KEY,
  post_id    INTEGER NULL, --FK reference to the liked post
  comment_id INTEGER NULL, --FK reference to the liked comment
